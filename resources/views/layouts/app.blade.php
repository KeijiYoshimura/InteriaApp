    ...
    <div id="app1">
        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                ...
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link" href="{{ url('/users') }}">All Users</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ url('/followInteriors') }}">Followings</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ url('/favoriteInteriors') }}">Favorites</span></a>
                    </li>
                    <li class="nav-item">
